...
## Skill
Load `skills/simple-webpage/SKILL.md` for all webpage generation. It defines philosophy, patterns,
...
- Cookbook patterns in `skills/simple-webpage/cookbook/` — browse before writing new CSS.
- Design tokens in `skills/simple-webpage/tokens/` — import via `<link>`.
